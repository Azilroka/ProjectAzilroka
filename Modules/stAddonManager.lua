...
function stAM:BuildFrame()
	...
	Title:SetFont(PA.LSM:Fetch('font', self.db['Font']), 14, 'OUTLINE')
	...
	Close.Text:SetFont(PA.LSM:Fetch('font', self.db['Font']), 12, 'OUTLINE')
	...
	Search:SetFont(PA.LSM:Fetch('font', self.db['Font']), 12, 'OUTLINE')
	...
	Reload.Text:SetFont(PA.LSM:Fetch('font', self.db['Font']), 12, 'OUTLINE')
	...
	Profiles.Text:SetFont(PA.LSM:Fetch('font', self.db['Font']), 12, 'OUTLINE')
